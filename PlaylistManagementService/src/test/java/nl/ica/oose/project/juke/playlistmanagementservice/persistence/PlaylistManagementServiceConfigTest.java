...
public class PlaylistManagementServiceConfigTest {
    ...
    PlaylistManagementServiceConfig fullConfig;
    PlaylistManagementServiceConfig blankConfig;

    @Before
    public void startUp() {
        fullConfig = new PlaylistManagementServiceConfig(LOCATION, USERNAME, PASSWORD, DRIVER);
        blankConfig = new PlaylistManagementServiceConfig();
    }
