...
public class SearchServiceConfigTest {
    ...
    SearchServiceConfig fullConfig;
    SearchServiceConfig blankConfig;

    @Before
    public void startUp() {
        fullConfig = new SearchServiceConfig(DRIVER, LOCATION, USERNAME, PASSWORD);
        blankConfig = new SearchServiceConfig();
    }
