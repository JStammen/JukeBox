...
public class PlaylistGetServiceConfigTest {
    ...
    PlaylistGetServiceConfig fullConfig;
    PlaylistGetServiceConfig blankConfig;

    @Before
    public void startUp() {
        fullConfig = new PlaylistGetServiceConfig(LOCATION, USERNAME, PASSWORD, DRIVER);
        blankConfig = new PlaylistGetServiceConfig();
    }
